...
pub(crate) fn handle_glx_single(state: &mut ClientState, data: &[u8], seq: u16) -> Vec<u8> {
    ...
    match gl_opcode {
        ...
        X_GLsop_GetTexLevelParameterfv => single_query::handle_get_tex_level_parameterfv(payload, seq),
        X_GLsop_GetTexLevelParameteriv => single_query::handle_get_tex_level_parameteriv(payload, seq),
