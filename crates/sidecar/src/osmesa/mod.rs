...
// OSMesa- and GL-specific enum values referenced by this crate. Add a new
// constant here only when something inside the workspace actually uses it;
// don't reintroduce the full GL enum table.
