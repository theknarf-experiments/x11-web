...
use x11rb_protocol::protocol::render::{
    PictOp, ADD_GLYPHS_REQUEST, ADD_TRAPS_REQUEST, CHANGE_PICTURE_REQUEST,
    COMPOSITE_GLYPHS16_REQUEST, COMPOSITE_GLYPHS32_REQUEST, COMPOSITE_GLYPHS8_REQUEST,
    COMPOSITE_REQUEST, CREATE_ANIM_CURSOR_REQUEST, CREATE_CONICAL_GRADIENT_REQUEST,
    CREATE_CURSOR_REQUEST, CREATE_GLYPH_SET_REQUEST, CREATE_LINEAR_GRADIENT_REQUEST,
    CREATE_PICTURE_REQUEST, CREATE_RADIAL_GRADIENT_REQUEST, CREATE_SOLID_FILL_REQUEST,
    FILL_RECTANGLES_REQUEST, FREE_GLYPHS_REQUEST, FREE_GLYPH_SET_REQUEST, FREE_PICTURE_REQUEST,
...
pub fn handle_render_request(state: &mut ClientState, data: &[u8], seq: u16) -> Vec<u8> {
    ...
    match minor {
        ...
        | CREATE_CONICAL_GRADIENT_REQUEST => {
            gradient::handle_create_gradient_fill(state, data, seq)
        }
