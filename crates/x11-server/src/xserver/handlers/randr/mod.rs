...
use x11rb_protocol::protocol::randr::{
    ...
    FREE_LEASE_REQUEST, GET_CRTC_GAMMA_REQUEST, GET_CRTC_GAMMA_SIZE_REQUEST,
    GET_CRTC_INFO_REQUEST, GET_CRTC_TRANSFORM_REQUEST, GET_MONITORS_REQUEST,
    GET_OUTPUT_INFO_REQUEST, GET_OUTPUT_PRIMARY_REQUEST, GET_OUTPUT_PROPERTY_REQUEST,
    GET_PANNING_REQUEST, GET_PROVIDER_INFO_REQUEST, GET_PROVIDER_PROPERTY_REQUEST,
    GET_PROVIDERS_REQUEST, GET_SCREEN_INFO_REQUEST, GET_SCREEN_RESOURCES_CURRENT_REQUEST,
    GET_SCREEN_RESOURCES_REQUEST, GET_SCREEN_SIZE_RANGE_REQUEST, LIST_OUTPUT_PROPERTIES_REQUEST,
