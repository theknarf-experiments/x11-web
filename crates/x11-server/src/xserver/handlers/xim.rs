...
///
/// Delegates to libxkbcommon, which knows every legacy keysym block (Latin-1
/// through Latin-9, Greek, Cyrillic, Arabic, Hebrew, Thai, Korean, currency)
/// plus the 0x01000000 Unicode-encoded range.
