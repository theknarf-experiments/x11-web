...
pub(crate) fn dispatch(opcode: u16, data: &[u8]) -> Option<bool> {
    match opcode {
        ...
        1 => {
            if data.len() >= 4 {
                let list = super::read_u32_le(data, 0);
        ...
        2 => {
            if data.len() >= 8 {
                ...
                let list_type = super::read_u32_le(data, 4);
        ...
        3 => {
            if data.len() >= 4 {
                let base = super::read_u32_le(data, 0);
        ...
        5 => {
            if data.len() >= 24 {
                let w = super::read_i32_le(data, 0);
                let h = super::read_i32_le(data, 4);
                let xo = super::read_f32_le(data, 8);
                let yo = super::read_f32_le(data, 12);
                let xm = super::read_f32_le(data, 16);
                let ym = super::read_f32_le(data, 20);
        ...
        10 => {
            if data.len() >= 6 {
                let r = super::read_i16_le(data, 0);
                let g = super::read_i16_le(data, 2);
                let b = super::read_i16_le(data, 4);
        ...
        12 => {
            if data.len() >= 12 {
                let r = super::read_i32_le(data, 0);
                let g = super::read_i32_le(data, 4);
                let b = super::read_i32_le(data, 8);
        ...
        14 => {
            if data.len() >= 6 {
                let r = super::read_u16_le(data, 0);
                let g = super::read_u16_le(data, 2);
                let b = super::read_u16_le(data, 4);
        ...
        15 => {
            if data.len() >= 24 {
                let r = super::read_f64_le(data, 0);
                let g = super::read_f64_le(data, 8);
                let b = super::read_f64_le(data, 16);
        ...
        17 => {
            if data.len() >= 8 {
                ...
                let g = super::read_i16_le(data, 2);
                let b = super::read_i16_le(data, 4);
                let a = super::read_i16_le(data, 6);
        ...
        18 => {
            if data.len() >= 16 {
                ...
                let g = super::read_i32_le(data, 4);
                let b = super::read_i32_le(data, 8);
                let a = super::read_i32_le(data, 12);
        ...
        20 => {
            if data.len() >= 8 {
                ...
                let g = super::read_u16_le(data, 2);
                let b = super::read_u16_le(data, 4);
                let a = super::read_u16_le(data, 6);
        ...
        21 => {
            if data.len() >= 32 {
                ...
                let g = super::read_f64_le(data, 8);
                let b = super::read_f64_le(data, 16);
                let a = super::read_f64_le(data, 24);
        ...
        24 => {
            if data.len() >= 8 {
                let c = super::read_f64_le(data, 0);
                osmesa::gl_indexd(c);
            }
        }
        // glIndexfv
        ...
        26 => {
            if data.len() >= 4 {
                let c = super::read_i32_le(data, 0);
                osmesa::gl_indexi(c);
            }
        }
        // glIndexsv
        27 => {
            if data.len() >= 2 {
                let c = super::read_i16_le(data, 0);
                osmesa::gl_indexs(c);
            }
        }
        ...
        31 => {
            if data.len() >= 12 {
                ...
                let z = super::read_i32_le(data, 8);
        ...
        32 => {
            if data.len() >= 6 {
                let x = super::read_i16_le(data, 0);
                let y = super::read_i16_le(data, 2);
                let z = super::read_i16_le(data, 4);
        ...
        41 => {
            if data.len() >= 32 {
                ...
                let y = super::read_f64_le(data, 8);
                let z = super::read_f64_le(data, 16);
                let w = super::read_f64_le(data, 24);
        ...
        42 => {
            if data.len() >= 16 {
                ...
                let y = super::read_f32_le(data, 4);
                let z = super::read_f32_le(data, 8);
                let w = super::read_f32_le(data, 12);
        ...
        43 => {
            if data.len() >= 16 {
                ...
                let y = super::read_i32_le(data, 4);
                let z = super::read_i32_le(data, 8);
                let w = super::read_i32_le(data, 12);
        ...
        44 => {
            if data.len() >= 16 {
                let x1 = super::read_f32_le(data, 0);
                let y1 = super::read_f32_le(data, 4);
                let x2 = super::read_f32_le(data, 8);
                let y2 = super::read_f32_le(data, 12);
        ...
        45 => {
            if data.len() >= 32 {
                let x1 = super::read_f64_le(data, 0);
                let y1 = super::read_f64_le(data, 8);
                let x2 = super::read_f64_le(data, 16);
                let y2 = super::read_f64_le(data, 24);
        ...
        46 => {
            if data.len() >= 16 {
                let x1 = super::read_i32_le(data, 0);
                let y1 = super::read_i32_le(data, 4);
                let x2 = super::read_i32_le(data, 8);
                let y2 = super::read_i32_le(data, 12);
        ...
        47 => {
            if data.len() >= 8 {
                let x1 = super::read_i16_le(data, 0);
                let y1 = super::read_i16_le(data, 2);
                let x2 = super::read_i16_le(data, 4);
                let y2 = super::read_i16_le(data, 6);
        ...
        50 => {
            if data.len() >= 8 {
                let s = super::read_f64_le(data, 0);
        ...
        51 => {
            if data.len() >= 4 {
                let s = super::read_f32_le(data, 0);
        ...
        53 => {
            if data.len() >= 2 {
                let s = super::read_i16_le(data, 0);
        ...
        54 => {
            if data.len() >= 8 {
                let s = super::read_f32_le(data, 0);
                let t = super::read_f32_le(data, 4);
        ...
        55 => {
            if data.len() >= 16 {
                let s = super::read_f64_le(data, 0);
                let t = super::read_f64_le(data, 8);
        ...
        56 => {
            if data.len() >= 16 {
                let s = super::read_f32_le(data, 0);
                let t = super::read_f32_le(data, 4);
                let r = super::read_f32_le(data, 8);
                let q = super::read_f32_le(data, 12);
        ...
        62 => {
            if data.len() >= 8 {
                let s = super::read_i32_le(data, 0);
                let t = super::read_i32_le(data, 4);
        ...
        63 => {
            if data.len() >= 4 {
                let s = super::read_i16_le(data, 0);
                let t = super::read_i16_le(data, 2);
        ...
        64 => {
            if data.len() >= 24 {
                let s = super::read_f64_le(data, 0);
                let t = super::read_f64_le(data, 8);
                let r = super::read_f64_le(data, 16);
        ...
        66 => {
            if data.len() >= 12 {
                let s = super::read_i32_le(data, 0);
                let t = super::read_i32_le(data, 4);
                let r = super::read_i32_le(data, 8);
        ...
        67 => {
            if data.len() >= 6 {
                let s = super::read_i16_le(data, 0);
                let t = super::read_i16_le(data, 2);
                let r = super::read_i16_le(data, 4);
        ...
        76 => {
            if data.len() >= 8 {
                ...
                let y = super::read_i16_le(data, 2);
                let z = super::read_i16_le(data, 4);
                let w = super::read_i16_le(data, 6);
        ...
        48 => {
            if data.len() >= 32 {
                ...
                let t = super::read_f64_le(data, 8);
                let r = super::read_f64_le(data, 16);
                let q = super::read_f64_le(data, 24);
        ...
        49 => {
            if data.len() >= 16 {
                ...
                let t = super::read_i32_le(data, 4);
                let r = super::read_i32_le(data, 8);
                let q = super::read_i32_le(data, 12);
        ...
        151 => {
            if data.len() >= 8 {
                let u = super::read_f64_le(data, 0);
        ...
        152 => {
            if data.len() >= 4 {
                let u = super::read_f32_le(data, 0);
        ...
        153 => {
            if data.len() >= 16 {
                let u = super::read_f64_le(data, 0);
                let v = super::read_f64_le(data, 8);
        ...
        154 => {
            if data.len() >= 8 {
                let u = super::read_f32_le(data, 0);
                let v = super::read_f32_le(data, 4);
        ...
        155 => {
            if data.len() >= 12 {
                let mode = super::read_u32_le(data, 0);
                let i1 = super::read_i32_le(data, 4);
                let i2 = super::read_i32_le(data, 8);
        ...
        156 => {
            if data.len() >= 4 {
                let i = super::read_i32_le(data, 0);
        ...
        157 => {
            if data.len() >= 20 {
                ...
                let i1 = super::read_i32_le(data, 4);
                let i2 = super::read_i32_le(data, 8);
                let j1 = super::read_i32_le(data, 12);
                let j2 = super::read_i32_le(data, 16);
        ...
        158 => {
            if data.len() >= 8 {
                let i = super::read_i32_le(data, 0);
                let j = super::read_i32_le(data, 4);
        ...
        165 => {
            if data.len() >= 20 {
                ...
                let stride = super::read_i32_le(data, 12);
                let order = super::read_i32_le(data, 16);
        ...
        166 => {
            if data.len() >= 32 {
                ...
                let stride = super::read_i32_le(data, 20);
                let order = super::read_i32_le(data, 24);
        ...
        167 => {
            if data.len() >= 36 {
                ...
                let u1 = super::read_f32_le(data, 4);
                let u2 = super::read_f32_le(data, 8);
                let ustride = super::read_i32_le(data, 12);
                let uorder = super::read_i32_le(data, 16);
                let v1 = super::read_f32_le(data, 20);
                let v2 = super::read_f32_le(data, 24);
                let vstride = super::read_i32_le(data, 28);
                let vorder = super::read_i32_le(data, 32);
        ...
        168 => {
            if data.len() >= 52 {
                ...
                let u1 = super::read_f64_le(data, 4);
                let u2 = super::read_f64_le(data, 12);
                let ustride = super::read_i32_le(data, 20);
                let uorder = super::read_i32_le(data, 24);
                let v1 = super::read_f64_le(data, 28);
                let v2 = super::read_f64_le(data, 36);
                let vstride = super::read_i32_le(data, 44);
                let vorder = super::read_i32_le(data, 48);
        ...
        171 => {
            if data.len() >= 24 {
                ...
                let u1 = super::read_f32_le(data, 4);
                let u2 = super::read_f32_le(data, 8);
                let vn = super::read_i32_le(data, 12);
                let v1 = super::read_f32_le(data, 16);
                let v2 = super::read_f32_le(data, 20);
        ...
        173 => {
            if data.len() >= 20 {
                ...
                let type_ = super::read_u32_le(data, 16);
        ...
        4107 => {
            if data.len() >= 36 {
                ...
                let format = super::read_u32_le(data, 28);
                let type_ = super::read_u32_le(data, 32);
        ...
        4124 => {
            if data.len() >= 4 {
                let coord = super::read_f32_le(data, 0);
        ...
        4125 => {
            if data.len() >= 8 {
                let coord = super::read_f64_le(data, 0);
        ...
        4116 => {
            if data.len() >= 16 {
                let mode = super::read_u32_le(data, 0);
                let first = super::read_i32_le(data, 4);
                let count = super::read_i32_le(data, 8);
                let num_components = super::read_u32_le(data, 12) as usize;
        ...
        4117 => {
            if data.len() >= 12 {
                let mode = super::read_u32_le(data, 0);
                let count = super::read_i32_le(data, 4);
                let index_type = super::read_u32_le(data, 8);
                let indices = &data[12..];
                unsafe {
